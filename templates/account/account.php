...
<main class="account-page">
    ...
    <section class="account-panel account-panel--wide" id="caldav" aria-labelledby="caldav-title">
        ...
        <p class="account-copy">Create a separate CalDAV password for each calendar app. Do not use your Elonn account password.</p>
        ...
        <?php if ($davToken !== null): ?>
            <section class="caldav-secret" aria-labelledby="caldav-secret-title">
                <h3 id="caldav-secret-title">Save this password now</h3>
                <p>This CalDAV password is shown only once.</p>
        ...
        <dl class="caldav-settings">
            ...
            <div><dt>Username</dt><dd><code><?= htmlspecialchars((string) ($identity['email'] ?? ''), ENT_QUOTES, 'UTF-8') ?></code></dd></div>
            <div><dt>Password</dt><dd>Use a generated CalDAV password below.</dd></div>
        </dl>
